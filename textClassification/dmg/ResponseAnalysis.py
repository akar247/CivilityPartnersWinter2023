...
btn_choosefile = Button(master=frame2,text='Choose File',command=open_xfile, fg = "black", font = "Future 10", bg=bg_button)
btn_cont = Button(master=home,text='Continue?',command=class_choice, fg = "black", font = "Future 10", bg=bg_button, height = 1, width=10)
btn_classify = Button(master=home,text='Classify?',command=lambda: [reset_screen(), classify()], fg = "black", font = "Future 10", bg=bg_button, height = 1, width=10)
